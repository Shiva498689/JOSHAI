...
from cruduser import init_db_pool, close_db_pool, get_pool, get_by_email, create_user, update_user, create_schema, usage_schema, upadate_schema, Category, Gender, get_by_id
...
async def search_jossa(query: str) -> str:
    ...
    try:
        ...
        if response:
            print(f"   -> First chunk preview: {response[0][:100]}...")
